...
inline void spawn_blood_splatters(
	...
	const auto max_distance = std::min(130.0f, params.max_distance_base + 
...
inline void spawn_blood_splatters_omnidirectional(
	...
	omni_params.min_distance = std::min(550.f, damage_amount)/3;
	omni_params.max_distance_base = std::min(550.f, damage_amount)/2;
